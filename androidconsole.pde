...
ControlPanel utilPanel, launchPanel, hyperPanel, dropPanel, warzonePanel, landPanel, deadPanel, lightPanel, cometPanel;
...
void setup() {
  ...
  cometPanel = new CometPanel("comet", this);
  tabStrip.addPanel(cometPanel);
